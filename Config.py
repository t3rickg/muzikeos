...
class Config(object):
    ...
    ASSISTANT_ID = int(os.environ.get("ASSISTANT_ID", "6282467628")) # telegram I'd not Username
    AUTO_LEAVE_TIME = int(os.environ.get("AUTO_LEAVE_ASSISTANT_TIME", "54000")) # in seconds
    AUTO_LEAVE = os.environ.get('AUTO_LEAVING_ASSISTANT', 6282467628) # Change it to "True"
